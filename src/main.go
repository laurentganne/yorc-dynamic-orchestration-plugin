...
func main() {
	...
	servConfig.DelegateSupportedTypes = []string{`org\.lexis\.common\.dynamic\.orchestration\.nodes\..*`}
	...
	servConfig.OperationSupportedArtifactTypes = []string{"org.alien4cloud.artifacts.AnsiblePlaybook"}
